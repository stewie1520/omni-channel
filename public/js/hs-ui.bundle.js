            ...
            return (
              ...
              (o = [
                    ...
                    (o.style.display = "block"),
                      ...
                      this.afterTransition(o, function () {
                        t.classList.contains("active") &&
                          ((o.style.height = ""),
                          e._fireEvent("open", t),
                          e._dispatch("open.hs.accordion", t, t));
                      });
                  },
                },
                {
                  ...
                  value: function (t) {
                    var e = this,
                      o = t.querySelector(".hs-accordion-content");
                    (o.style.height = "".concat(o.scrollHeight, "px")),
                      setTimeout(function () {
                        o.style.height = 0;
                      }),
                      this.afterTransition(o, function () {
                        t.classList.contains("active") ||
                          ((o.style.display = ""),
                          e._fireEvent("hide", t),
                          e._dispatch("hide.hs.accordion", t, t));
                      }),
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = this,
                      o = t.closest(".hs-accordion-group");
                  ...
                  value: function (t) {
                    ...
                    t.classList.add("open"),
                      ...
                      document
                        ...
                        .forEach(function (e) {
                          t.closest(e.getAttribute("data-hs-collapse")) &&
                      ...
                      this.afterTransition(t, function () {
                        t.classList.contains("open") &&
                          ((t.style.height = ""),
                          e._fireEvent("open", t),
                          e._dispatch("open.hs.collapse", t, t));
                      });
                  },
                },
                {
                    ...
                    (t.style.height = "".concat(t.scrollHeight, "px")),
                      ...
                      this.afterTransition(t, function () {
                        t.classList.contains("open") ||
                          ...
                          (t.style.height = null),
                          e._fireEvent("hide", t),
                          e._dispatch("hide.hs.collapse", t, t),
                          t
                ...
                (t.absoluteStrategyModifiers = [
                  {
                    ...
                    fn: function (t) {
                      (t.state.elements.popper.style.position =
                        t.state.styles.popper.position),
              ...
              (o = [
                {
                  ...
                  value: function () {
                    ...
                    document.addEventListener("click", function (e) {
                      ...
                      n &&
                        (n.classList.contains("open") ? t.close(n) : t.open(n));
                    }),
                      document.addEventListener("mousemove", function (e) {
                        ...
                        o.closest(".hs-dropdown-menu"),
                          !n ||
                            "hover" !==
                              n.getAttribute("data-hs-dropdown-trigger") ||
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = t.querySelector(".hs-dropdown-menu"),
                      ...
                      r =
                        t.getAttribute("data-hs-dropdown-strategy") || "fixed",
                    ...
                    (0, n.fi)(t, e, {
                      ...
                      modifiers: [].concat(
                        c(
                          "absolute" === r ? this.absoluteStrategyModifiers : []
                        ),
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = c(
                      t.querySelector(".hs-dropdown-menu").querySelectorAll("a")
                    ).filter(function (t) {
                      return !t.disabled;
                    });
                    e.length && e[0].focus();
                        ...
                        return n.findIndex(function (t, n) {
                          return (
                            t.innerText.toLowerCase().charAt(0) ===
                              e.toLowerCase() && o._history.existsInHistory(n)
                          );
                        });
                      },
                      i = r();
              ...
              (o = [
                  ...
                  value: function () {
                    ...
                    document.addEventListener("click", function (e) {
                      ...
                      if (
                        ((n &&
                          (n.classList.contains("open") ||
                            n.parentElement.closest(t.selector))) ||
                          t._closeOthers(),
                        r && !i)
                      ) {
                        if (
                          ...
                          return;
                        if (n.parentElement.closest(t.selector))
                          return t._closeAll();
                        if ("hover" === a && n.classList.contains("open"))
                          return t.close(n);
                      }
                      ("hover" === a && c) ||
                        (n.classList.contains("open") ? t.close(n) : t.open(n));
                      ...
                      document
                        .querySelectorAll(
                          '.hs-mega-menu[data-hs-mega-menu-trigger="hover"]'
                        )
                        .forEach(function (e) {
                          e.addEventListener("mouseenter", function (o) {
                            e.querySelector(".hs-mega-menu-content"),
                              e && t._hover(e);
                          });
                        }),
                      document.addEventListener(
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    document
                      ...
                      .forEach(function (e) {
                        "false" !=
                          e.getAttribute("data-hs-mega-menu-auto-close") &&
                          t.close(e);
                      });
                  },
                },
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = this;
                    "flex" ===
                      window.getComputedStyle(t.closest("nav")).display &&
                      (this.open(t),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    window.getComputedStyle(e),
                      parseInt(o.left) + parseInt(o.width) >
                        window.innerWidth &&
                    ...
                    var e = t.querySelector(".hs-mega-menu-content"),
                      o = a(e.querySelectorAll("a, button"))
                        ...
                        .filter(function (t) {
                          return (
                            !t.disabled &&
                            t.closest(".hs-mega-menu-content") === e
                          );
                        }),
                      n =
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = t.querySelector(".hs-mega-menu-content"),
                      o = a(e.querySelectorAll("a, button")).filter(function (
                        t
                      ) {
                        return (
                          !t.disabled &&
              ...
              (o = [
                {
                  ...
                  value: function () {
                    ...
                    document.addEventListener("click", function (e) {
                      ...
                      return n
                        ? t.close(n.closest(".hs-modal.open"))
                        : o
                        ? t.toggle(
                            document.querySelector(
                              o.getAttribute("data-hs-modal")
                            )
                          )
                        : void (r && t._onBackdropClick(e.target));
                    }),
                      document.addEventListener("keydown", function (e) {
                        if (27 === e.keyCode) {
                          ...
                          setTimeout(function () {
                            "false" !==
                              o.getAttribute("data-hs-modal-keyboard") &&
                              t.close(o);
                          });
                        }
                      });
                  ...
                  value: function (t) {
                    ...
                    return new Promise(function (o) {
                      t &&
                        ...
                        e.afterTransition(t.firstElementChild, function () {
                          t.classList.add("hidden"),
                            e._destroyBackdrop(),
                            e._fireEvent("close", t),
                            e._dispatch("close.hs.modal", t, t),
                ...
                },
                {
                  ...
                  value: function (t) {
                    "static" != t.getAttribute("data-hs-modal-backdrop") &&
                      this.close(t);
                  },
                },
                {
                  ...
                  value: function (t) {
                    var e =
                        t.getAttribute("data-hs-modal-backdrop-container") ||
                        !1,
                      o = document.createElement("div");
                    document.querySelectorAll(
                      "[data-hs-modal-backdrop-template]"
                    ).length > 1 ||
                      (e &&
                        ((o = document
                          .querySelector(e)
                  ...
                  value: function () {
                    ...
                    document.addEventListener("click", function (e) {
                      ...
                      o &&
                        t.toggle(
                          document.querySelector(
                            o.getAttribute("data-hs-offcanvas")
                          )
                        );
                    }),
                      document.addEventListener("keydown", function (e) {
                        if (27 === e.keyCode) {
                          ...
                          if (!o) return;
                          "false" !==
                            o.getAttribute("data-hs-offcanvas-keyboard") &&
                            t.close(o);
                        }
                      });
                  },
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (t) {
                      var o = document.querySelector(".hs-offcanvas.show"),
                        n =
                          "true" !== t.getAttribute("data-hs-offcanvas-scroll");
                      if (o)
                        return this.close(o).then(function () {
                          return e.open(t);
                        });
                      this._buildBackdrop(t),
                        t.classList.remove("hidden"),
                        setTimeout(function () {
                          n && (document.body.style.overflow = "hidden"),
                            ...
                            e._fireEvent("show", t),
                            e._dispatch("open.hs.offcanvas", t, t),
                            t.classList.remove("hidden");
                        });
                    }
                  },
                  ...
                  value: function (t) {
                    ...
                    return new Promise(function (o) {
                      t &&
                        ...
                        e.afterTransition(t, function () {
                          t.classList.contains("show") ||
                            (t.classList.add("hidden"),
                            e._destroyBackdrop(),
                            e._fireEvent("close", t),
                            e._dispatch("close.hs.offcanvas", t, t),
                            (document.body.style.overflow = ""),
                            o(t));
                        }));
                    });
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = this,
                      o =
                        t.getAttribute(
                          "data-hs-offcanvas-backdrop-container"
                        ) || !1,
                      n =
                        "false" !==
                        t.getAttribute("data-hs-offcanvas-close-on-backdrop");
                    if (
                      "false" !== t.getAttribute("data-hs-offcanvas-backdrop")
                    ) {
                      ...
                      o
                        ...
                        r.setAttribute(
                          "data-hs-offcanvas-backdrop-template",
                          ""
                        ),
          ...
          var s = (function (t) {
            ...
            function l() {
              ...
              return (
                ...
                ((t = u.call(this, "[data-hs-scrollspy] ")).activeSection =
                  null),
                t
              );
            }
                    ...
                    document
                      ...
                      .forEach(function (e) {
                        var o = document.querySelector(
                            e.getAttribute("data-hs-scrollspy")
                          ),
                          n = e.querySelectorAll("[href]"),
                          r = o.children,
                          i = parseInt(
                            e.getAttribute("data-hs-scrollspy-offset") || 0
                          ),
                          a = e.getAttribute(
                  ...
                  value: function (t) {
                    var e = t.ev,
                      ...
                      c =
                        e.target === document
                          ? 0
                          : parseInt(e.target.getBoundingClientRect().top),
                      s = parseInt(r.getBoundingClientRect().top) - a - c,
                      u = r.offsetHeight;
                    if (s <= 0 && s + u > 0) {
              ...
              (o = [
                  ...
                  value: function () {
                    ...
                    document.addEventListener("click", function (e) {
                      ...
                      o &&
                        t.toggle(
                          document.querySelector(
                            o.getAttribute("data-hs-sidebar")
                          )
                        );
                    }),
                      document.addEventListener("keydown", function (e) {
                        if (27 === e.keyCode) {
                          ...
                          if (!o) return;
                          "false" !==
                            o.getAttribute("data-hs-sidebar-keyboard") &&
                            t.close(o);
                        }
                      }),
                      ...
                      this._buildBackdrop(t),
                        ...
                        setTimeout(function () {
                          n && (document.body.style.overflow = "hidden"),
                            ...
                            e._fireEvent("show", t),
                            e._dispatch("open.hs.sidebarl", t, t);
                        });
                    }
                  },
                },
                      ...
                      t &&
                        ...
                        e.afterTransition(t, function () {
                          t.classList.add("hidden"),
                            e._destroyBackdrop(),
                            e._fireEvent("close", t),
                            e._dispatch("close.hs.sidebarl", t, t),
                            (document.body.style.overflow = ""),
                            o(t);
                        }));
                    });
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = this,
                      o =
                        t.getAttribute("data-hs-sidebar-backdrop-container") ||
                        !1,
                      n =
                        "false" !==
                        t.getAttribute("data-hs-sidebar-close-on-backdrop");
                    if (
                      "false" !== t.getAttribute("data-hs-sidebar-backdrop")
                    ) {
                      var r = document.createElement("div");
                      o
                        ? (r = document.querySelector(o).cloneNode(!0))
                ...
                },
                {
                  ...
                  value: function () {
                    var t = document.querySelector(
                      "[data-hs-sidebar-backdrop-template]"
                    );
                    t &&
                      (t.classList.add("opacity-0"),
                      this.afterTransition(t, function () {
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = t.querySelector(
                      t.getAttribute("data-hs-smooth-scroll-to")
                    );
                    if (e) {
                      var o =
                          t.getAttribute("data-hs-smooth-scroll-offset") || 0,
              ...
              (o = [
                  ...
                  value: function () {
                    ...
                    document.addEventListener(
                      ...
                      document
                        ...
                        .forEach(function (e) {
                          var o = document.querySelector(
                            e.getAttribute("hs-data-tab-select")
                          );
                          o &&
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = document.querySelector(
                      ...
                      a = i
                        ? document.querySelector(
                            i.getAttribute("hs-data-tab-select")
                          )
                        : null;
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (e) {
                      var o = r(e.querySelectorAll(this.selector)).filter(
                          function (t) {
                            return !t.disabled;
                          }
                        ),
                  ...
                  value: function () {
                    ...
                    document.addEventListener("click", function (e) {
                      ...
                      o &&
                        ...
                        o &&
                          "click" ===
                            o.getAttribute("data-hs-tooltip-trigger") &&
                          t._click(o);
                    }),
                      document.addEventListener("mousemove", function (e) {
                        var o = e.target.closest(t.selector);
                  ...
                  value: function (t) {
                    ...
                    t
                      ...
                      setTimeout(function () {
                        t.classList.add("show"),
                          e._fireEvent("show", t),
                          e._dispatch("show.hs.tooltip", t, t);
                      });
                  },
                },
                {
        ...
        714: (t, e, o) => {
          ...
          function N(t) {
            ...
            return function (t, e, o) {
              ...
              return (
                f.setOptions(o).then(function (t) {
            ...
            if (f) {
              ...
              q === n(o) &&
                ...
                (i === E || ((i === A || i === x) && a === T)) &&
                  ((L = j),
                  (g -=
                    (y && P.visualViewport ? P.visualViewport.height : q[R]) -
                    r.height),
                  (g *= l ? 1 : -1)),
                (i !== A && ((i !== E && i !== j) || a !== T)) ||
                  ((_ = x),
                  (b -=
                    (y && P.visualViewport ? P.visualViewport.width : q[C]) -
                    r.width),
                  (b *= l ? 1 : -1));
            }
            var D,
                ...
                var n =
                    "clippingParents" === e
                      ? (function (t) {
                          var e = O(g(t)),
                            o =
                              ["absolute", "fixed"].indexOf(h(t).position) >=
                                0 && i(t)
                                ? k(t)
                                : t;
                          return r(o)
              ...
              },
              {
                ...
                effect: function (t) {
                  ...
                  return (
                    ...
                    (e.styles = o),
                    e.elements.arrow &&
                      Object.assign(e.elements.arrow.style, o.arrow),
                    function () {
                      Object.keys(e.elements).forEach(function (t) {
                        var n = e.elements[t],
                          r = e.attributes[t] || {},
                          a = Object.keys(
                            e.styles.hasOwnProperty(t) ? e.styles[t] : o[t]
                          ).reduce(function (t, e) {
                            return (t[e] = ""), t;
                          }, {});
                        i(n) &&
                      ...
                      var r = o.mainAxis,
                        ...
                        m =
                          ...
                          (b !== v && y
                            ...
                            : [G(v)]),
                        g = [v].concat(m).reduce(function (t, o) {
                          return t.concat(
                            $(o) === L
                              ? (function (t, e) {
                                  void 0 === e && (e = {});
                      ...
                      for (
                        var z = function (t) {
                            var e = g.find(function (e) {
                              var o = S.get(e);
                              if (o)
                                return o.slice(0, t).every(function (t) {
                                  return t;
                                });
                            });
                  ...
                  if (P) {
                    if (i) {
                      var I,
                        ...
                        ot = it(0, T[N], K[N]),
                        nt = S
                          ? T[N] / 2 - X - ot - tt - D.mainAxis
                          : Y - ot - tt - D.mainAxis,
                        at = S
                          ? -T[N] / 2 + X + ot + et + D.mainAxis
                          : G + ot + et + D.mainAxis,
