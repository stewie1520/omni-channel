...
const fullCircleColorProps: Record<
  NonNullable<CircleProgressProps["variant"]>,
  string
> = {
  blue: "text-blue-200",
...
const strokeCircleColorProps: Record<
  NonNullable<CircleProgressProps["variant"]>,
  string
> = {
  blue: "text-blue-500",
...
export const CircleProgress = (props: CircleProgressProps) => {
  ...
  return (
    <div className="inline-flex relative items-center justify-center overflow-hidden rounded-full z-10">
      ...
      {props.image && (
        <div className="absolute items-center flex justify-center bg-[#f5effa] w-[40px] h-[40px] rounded-[40px] -z-10">
