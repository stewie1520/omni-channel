...
import { useOptionalComputedStudent } from "~/utils";

export default function Index() {
  const student = useOptionalComputedStudent();
  return (
              ...
              <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                {student ? (
                  <>
                    ...
                    >
                      View Notes for {student.fullName}
                    </Link>
                    <Form action="/logout" method="post">
                      <button
                        type="submit"
                        className="rounded bg-slate-600 py-3 px-4 text-blue-100 hover:bg-blue-500 active:bg-blue-600"
                      >
                        Logout
                      </button>
                    </Form>
